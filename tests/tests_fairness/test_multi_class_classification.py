...
class FairnessInMultiClassClassificationTest(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertTrue(automl._models[0].get_fairness_metric("sensitive__A") is not None)
        self.assertTrue(automl._models[0].get_fairness_metric("sensitive__B") is not None)
        self.assertTrue(automl._models[0].get_fairness_metric("sensitive__C") is not None)
