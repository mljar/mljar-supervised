...
class PreprocessingBoxTest(unittest.TestCase):
    def test_constructor_preprocessing_box(self):
        ...
        preprocess = PreprocessingBox(
            PreprocessingMissingValues.FILL_NA_MEDIAN,
            PreprocessingCategorical.CONVERT_INTEGER,
        )
        self.assertEqual(
            preprocess._missing_values_method, PreprocessingMissingValues.FILL_NA_MEDIAN
        )
        self.assertTrue(preprocess._missing_values is None)
        self.assertEqual(
            preprocess._categorical_method, PreprocessingCategorical.CONVERT_INTEGER
        )
    ...
    def test_fit_median_one_hot(self):
        ...
        self.assertTrue(
            "col2_a" in preprocess._categorical._convert_params["col2"]["new_columns"]
        )
        self.assertTrue(
            "col4_a" in preprocess._categorical._convert_params["col4"]["new_columns"]
        )
        self.assertTrue(
            "col4_b" in preprocess._categorical._convert_params["col4"]["new_columns"]
        )
        self.assertTrue(
            "col4_c" in preprocess._categorical._convert_params["col4"]["new_columns"]
        )
